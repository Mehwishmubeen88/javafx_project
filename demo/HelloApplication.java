...
public void withdrawCah() {
    ...
    public void setHomePage(Stage stage){
        ...
        if (!root.getChildren().contains(btn1)) {
            root.getChildren().addAll(btn1, btn2, btn3, btn4);//added button
        }
        Scene scene=new Scene(root,500,300);//scene created with stackpane
        stage.setScene(scene);//scene is set on stage
    }
    ...
    public void showAccountField(Stage stage){
        ...
        VBox root1=new VBox(12.0);//layout created
        ...
        if (!root1.getChildren().contains(btn5)) {
            ...
            Scene scene2=new Scene(root1,500,300);//scene created with stackpane
